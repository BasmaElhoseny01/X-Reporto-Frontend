...
// Styled Components
import { StyledTabs, ViewContainer } from "./ViewAccount.style";

// Components
import EditEmployeeInfo from "./EditAccountInfo/EditAccountInfo";
...
// Server Fetch
const fetchEmployeeData = async (id: number, token: string) => {
  try {
