...
function HeatMapSection(props: HeatMapSectionProps) {
  ...
  const getHeatmapImages = async (id: number) => {
    axios
      .get(`api/v1/results/${id}/get_heatmap/0`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        responseType: "blob",
    ...
    axios
      .get(`api/v1/results/${id}/get_heatmap/1`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        responseType: "blob",
    ...
    axios
      .get(`api/v1/results/${id}/get_heatmap/2`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        responseType: "blob",
    ...
    axios
      .get(`api/v1/results/${id}/get_heatmap/3`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        responseType: "blob",
    ...
    axios
      .get(`api/v1/results/${id}/get_heatmap/4`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        responseType: "blob",
    ...
    axios
      .get(`api/v1/results/${id}/get_heatmap/5`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        responseType: "blob",
    ...
    axios
      .get(`api/v1/results/${id}/get_heatmap/6`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        responseType: "blob",
    ...
    axios
      .get(`api/v1/results/${id}/get_heatmap/7`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        responseType: "blob",
  ...
  const getReport = async (path: string) => {
    axios
      .get(`/api/v1/results/download_file?file_path=${path}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  useEffect(() => {
    ...
    if (data === null) {
      if (props.caseId !== null) {
        ...
        axios
          .post(`api/v1/studies/${props.caseId}/run_heatmap`)
          .then((response) => {
