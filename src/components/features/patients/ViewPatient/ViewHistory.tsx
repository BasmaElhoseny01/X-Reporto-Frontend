...
import { ButtonContainer, SearchContainer, SearchInputContainer } from "../../../common/SearchInput/SearchInput.Style";
...
function ViewHistory({ onSearch }: SearchInputProps){
  ...
  return (
    <div>
      ...
      />
      <ButtonContainer>
        <PrimaryButton icon={<PlusOutlined />} onClick={handleAddXray}>Add X-ray</PrimaryButton>
      </ButtonContainer>
    </SearchContainer>
      <GeneralTable
